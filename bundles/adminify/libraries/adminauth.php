...
use Adminify\Models\User as User, Laravel\Auth\Drivers\Eloquent as Eloquent, Laravel\Hash, Laravel\Config;
class AdminAuth extends Eloquent{
	...
	public function attempt($arguments = array())
	{
		...
		{
			$username = Config::get('Adminify::auth.username');
		...
		$password_field = Config::get('Adminify::auth.password', 'password');
